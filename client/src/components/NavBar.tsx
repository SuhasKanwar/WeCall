...
export default function NavBar() {
  return (
    <motion.nav
      className="p-2 m-1 w-full flex justify-center rounded-2xl bg-gradient-to-b from-background/80 to-background/40 backdrop-blur-lg border border-border/40 shadow-lg relative overflow-hidden"
      initial="initial"
      whileHover="hover"
    >
      <motion.div
